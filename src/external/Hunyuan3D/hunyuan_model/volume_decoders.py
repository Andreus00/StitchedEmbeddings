...
from hunyuan_model.attention_blocks import CrossAttentionDecoder
from hunyuan_model.attention_processor import FlashVDMCrossAttentionProcessor, FlashVDMTopMCrossAttentionProcessor
...
class FlashVDMVolumeDecoding:
    ...
    def __call__(
        ...
        **kwargs,
        ...
        print(f"FlashVDMVolumeDecoding Resolution: {resolutions}")
